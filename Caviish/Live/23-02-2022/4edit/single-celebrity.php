                            ...
                            <div class="qodef-elements-holder qodef-two-columns qodef-responsive-mode-1024">
                                ...
                                <div class="qodef-elements-holder-item cav-celeb-details">
                                    <div class="qodef-elements-holder-item-inner">
                                        <div class="qodef-elements-holder-item-content" style="padding: 10%">
                                            ...
                                            <span class="celeb-sig">
                                                ...
                                                <img src="<?=get_field('celebrity_signature', get_the_ID())["url"]?>"
                                                    alt="">
                                                <?php }?>
                                            </span>
                                            <div class="celeb-social">
                                                ...
                                                <a itemprop="url" class=""
                                                    href="<?=get_field('celebrity_twitter', get_the_ID()) ? get_field('celebrity_twitter', get_the_ID()) : "#"?>"
                                                    target="_blank">
                                                    <span class="icon-normal"><i
...
if ($celebrity_term_url) {
    ?>
                                            <a itemprop="url" href="<?php echo $celebrity_term_url; ?>" target="_self"
