                    ...
                    <?php if ($genres != "") { ?>
                        <div class="game-info game-genres" >
                            ...
                            foreach ($genres as $key => $genre) {
                                ...
                                echo '<a href="' . esc_url($term_link) . '">' . $genre->name . '</a><br/>';
...
//                    var_dump($game_screenshot);
                    ...
                    if ($trailers != "") {
                        while (the_repeater_field(Xfire_Constants::Xfire_Game_Trailer, $game_id)) {
                            ?>
                            <a href="<?php echo get_sub_field(Xfire_Constants::Xfire_Game_Trailer_Video) ?>" class="html5lightbox" data-group="mygroup"  data-weblink="https://www.wonderplugin.com" data-weblinktarget="_self" title="Wordpress Carousel">
                                <img src="<?php echo get_sub_field(Xfire_Constants::Xfire_Game_Trailer_Preview) ?>" height="200px" width="100px">
                            </a>
