...
<div class="container">
    <div class="xfire-compare-wrapper">
        ...
        if (empty($compared_games)) {
            ?>
        <div class="xfire-compare-msg-error">
            <span><?php _e('No Games to compare', XFIRE_GAMES_TEXT_DOMAIN); ?></span>
        </div>
        <?php } else if (count($compared_games) > 4) { ?>
        <div class="xfire-compare-msg-error">
            <span><?php _e('Comparison between 4 games only', XFIRE_GAMES_TEXT_DOMAIN); ?></span>
        </div>
        <?php
        } else {
        ...
        <?php endif; ?>
        <div class="hs-wrapper-1">
            <div class="hs-div-1">
            </div>
        </div>

        <div class="hs-wrapper-2">
            <div class="hs-div-2">
                <table>
                    <thead>
                        <tr>
                    ...
                    foreach ($compared_games as $key => $compared_game) {
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="button remove-item-from-compare"
                                    title="<?php _e('remove game', XFIRE_GAMES_TEXT_DOMAIN) ?>"
                                    data-game-id="<?php echo $game_id; ?>">&#10005;</span>
                                <?php endif; ?>
                                <h3><a href="<?php echo get_the_permalink($game_id); ?>">
                                        <?php echo get_the_title($game_id); ?></a></h3>
                            ...
                            <td><?php
                                ...
                                <div class="desc-part-two" style="display: none;">
                                    <?php echo substr($game_content, 200) ?>
                                </div>
                            ...
                            <td>
                                <div class="compare-gallery"><?php
                                    ...
                                    <a href="<?php echo $game_screenshot ?>" data-showsocial="true"
                                        class="html5lightbox" data-group="mygroup"
                                        data-thumbnail="<?php echo $game_screenshot ?>" title="Toronto">
                                    ...
                                    <?php
                                                    ...
                                                    if ($meta_key == "xfire-game-trailer") {
                                                        ...
                                                        if (!empty($game_screenshots)) {
                                                            foreach ($game_screenshots as $key => $game_screenshot) {
                                                                ?>
                                    <a href="<?php echo $game_screenshot ?>" class="html5lightbox" data-group="mygroup"
