jQuery(document).ready(function () {
    ...
    // Duplicate Scroll bar for comparison table
    jQuery(function () {
        jQuery('.hs-wrapper-1').width(jQuery('.hs-wrapper-2').width());
        jQuery('.hs-div-1, .hs-div-2').width(jQuery('.hs-div-2 table').width());
        jQuery(".hs-wrapper-1").scroll(function () {
            jQuery(".hs-wrapper-2")
                .scrollLeft(jQuery(".hs-wrapper-1").scrollLeft());
        });
        jQuery(".hs-wrapper-2").scroll(function () {
            jQuery(".hs-wrapper-1")
                .scrollLeft(jQuery(".hs-wrapper-2").scrollLeft());
        });
    });
