...
while (have_posts()) :
    ...
    if (function_exists('get_field')) {
        ...
        $reddit_url = get_field(Xfire_Constants::Xfire_Game_Reddit_Url_Meta, $game_id);

        $reddit_desc = get_field(Xfire_Constants::Xfire_Game_Reddit_Desc_Meta, $game_id);
    }
...
<style>
.game-bg {
    background: url('<?php echo ($game_image != "") ? $game_image[0] : ""; ?>') center top / cover no-repeat #000;
}
</style>
                            ...
                            <?php
                                ...
                                if ($trailers) {
                                    ...
                                    foreach ($trailers as $key => $trailer) {
                                        if (isset($trailer['video']) && isset($trailer['img'])) {
                                            ?>
                            <a href="<?php echo $trailer['video'] ?>" class="html5lightbox" data-group="mygroup"
                                data-weblinktarget="_self" title="Wordpress Carousel">
                                <img src="<?php echo $trailer['img'] ?>" height="200px" width="100px">
                            </a>
...
//                            endif;
                    ...
                    <div class="game-info game-website">
                        ...
                        <div>
                            ...
                            <?php echo '<a href="' . esc_url($game_website) . '" target="_blank">' . $game_website . '</a><br/>'; ?>
                        </div>
                    </div>
                    <?php }
                        ?>
                    <?php if ($reddit_url) { ?>
                    <div class="game-info game-reddit-url">
                        <i class="bb-icon bb-ui-icon-reddit"></i>
                        <div>
                            <h2><?php _e('Reddit Url', XFIRE_GAMES_TEXT_DOMAIN); ?></h2>
                            <?php echo '<a href="' . esc_url($reddit_url) . '" target="_blank">' . $reddit_url . '</a><br/>'; ?>
                            <p></p>
                        </div>
                    </div>
                    <?php }
                        ?>
                    <?php if ($reddit_desc) { ?>
                    <div class="game-info game-reddit-desc">
                        <div>
                            <h2><?php _e('Reddit Description', XFIRE_GAMES_TEXT_DOMAIN); ?></h2>
                            <?php echo $reddit_desc; ?>
                        </div>
                    </div>
                    <?php }
                        ?>
                    ...
                    <?php
                        ...
                        ?>
                    <?php
                        $similar_games = Xfire_Functions::get_game_by_tax(Xfire_Constants::Xfire_Genre_Taxonomy, $genres_arr, $game_id);
                        ?>
                    <?php
                        if ($similar_games) {
                    ...
                    <div class="game-info game-similar">
                        <h2><?php _e('Similar Games', XFIRE_GAMES_TEXT_DOMAIN); ?></h2>
...
//                                }
                    ...
                    <div class="game-info game-alternative">
                        <h2><?php _e('Alternative Games', XFIRE_GAMES_TEXT_DOMAIN); ?></h2>
